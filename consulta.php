...
$sql ="SELECT * FROM `tb_registros` WHERE 1";

$consulta = mysqli_query($conexao, $sql);


?>
<center><h2 id="customers">Pedidos Garrafões</h2>
</center>
	<table id="customers">
		<tr>
			<td>Nome</td>
	...
	?>
		...
		<tr>
			...
			<td><center><?php echo $resultado['quantidade']?></center></td>
			<td><center><?php echo $resultado['turma']?></center></td>
